...
class ResourceViewer{
	...
	public function show($cell, $params){
		...
		$link2='<a href="#" class="hrf_nmrg interface_edit" id="select_form" type="'.$this->params[5055].'" elemid="'.$cell->id.'" action="9999" win_width="300" win_height="300"><span class="glyphicon glyphicon-pencil" style="color:black"></span></a>';
