...
class ResourceViewer{
	...
	public function show($cell, $params){
		...
		$val='<div class="res_value_link">'.$cell->value.'</div>';
		return '<div style="margin-bottom: 15px" onclick="load_data(2315, '.$this->params[5055].', '.$cell->id.')">'.$val.$link1.$link2.$link3.'</div>';
	}
}