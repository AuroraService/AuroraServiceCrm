...
class ResourceViewer{
  ...
  public function show($cell, $params){
    ...
    if ($flag_edit) $link2='<a href="#" class="hrf_nmrg interface_edit" id="select_form" onclick="findFormV(this)"><span class="glyphicon glyphicon-pencil" style="color:black"></span></a>';
