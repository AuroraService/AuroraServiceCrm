...
class TechModelViewer{
    ...
    public function show($cell, $params){
        ...
        $result['0']='<a href="#" onclick="updateFilter2(15366,5048,\'%COLUMN%='.$modelId.'\');sendForm(15366);" class="list-group-item'.$params[5099].'"><img src="icons/kuper.png" height="15" style="float: left; margin-right: 3px;"></img><h5 class="list-group-item-heading">'.$cell->items[50139][0].'</h5></a>';
        return $result;
    }
}