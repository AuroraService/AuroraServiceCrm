...
class FilterText2Viewer{
    ...
    public function show($cell, $params = null){
        ...
        $result[0]='<input onchange="str = \'%25COLUMN%25 LIKE \\\'%25\'+this.value+\'%25\\\'\'; editFilter(' . $formId . ',' . $params[5082] . ',str); data[\'' . $formId . '\'][\'50149\']=1; sendData2(data,data_container,false);">';
